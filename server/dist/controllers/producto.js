...
exports.uptadeProduct = exports.postProduct = exports.deleteProduct = exports.getProduct = exports.getProducts = void 0;
...
const uptadeProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    const { id } = req.params;
    try {
        const product = yield producto_1.default.findByPk(id);
...
exports.uptadeProduct = uptadeProduct;
